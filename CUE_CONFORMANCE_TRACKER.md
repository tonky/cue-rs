...
| **Total** | **~580+ fixtures** | | **74 conformance suites (100% pass)** |
...
| **`math`** | 🟢 **100%** | `Sqrt`, `Pow`, `Log`, `Sin`, `Cos`, `Tan`, `Asin`, `Acos`, `Atan`, `Atan2`, `Max`, `Min`, `Pi`, `E`, `MultipleOf`, `Floor`, `Ceil`, `Round`, `Trunc`, `Abs` | — |
